...
const grammarGraphNodes = [
  ...
  },
  {
    ...
    productions: [
      {
        id: "restRel-equal",
        symbols: [{ id: "equalEqual" }, { id: "addExpr" }],
      },
      {
        id: "restRel-not-equal",
        symbols: [{ id: "notEqual" }, { id: "addExpr" }],
      },
      { id: "restRel-less", symbols: [{ id: "less" }, { id: "addExpr" }] },
      {
        id: "restRel-less-equal",
        symbols: [{ id: "lessEqual" }, { id: "addExpr" }],
      },
      {
        id: "restRel-greater",
        symbols: [{ id: "greater" }, { id: "addExpr" }],
      },
      {
        id: "restRel-greater-equal",
        symbols: [{ id: "greaterEqual" }, { id: "addExpr" }],
      },
  ...
  {
    id: "configuredTerminator",
    label: "<configuredTerminator>",
    kind: "terminal",
    group: "tokens",
  },
...
const grammarGraphSections = [
  ...
  {
    id: "controlFlow",
    label: "Control Flow (merged into Statements)",
    nodes: [],
  },
  { id: "io", label: "IO (merged into Statements)", nodes: [] },
  {
    id: "functions",
    label: "Functions",
    nodes: [
