const interpreter = {
  label_defined_multiple_times:
    "Etiqueta '{labelName}' definida mais de uma vez!",
  ...
  if_requires_labels:
    "IF requer nomes de etiqueta como operand1/operand2. Recebido '{labelTrue}' e '{labelFalse}'",
  ...
  label_not_found:
    "Etiqueta '{label}' não encontrada! Etiquetas disponíveis: {availableLabels}",
  variable_not_found:
  ...
  array_read_out_of_bounds:
    "Leitura de array fora dos limites no índice '{index}'",
