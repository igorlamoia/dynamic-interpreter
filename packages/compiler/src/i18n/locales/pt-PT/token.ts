const token: Record<string, string> = {
  ...
  switch: "palavra reservada switch",
  case: "palavra reservada case",
  default: "palavra reservada default",
  variable: "palavra reservada variable",
  function: "palavra reservada function",

  // Símbolos
  semicolon: "final de instrução",
  comma: "vírgula",
  left_brace: "abrir chavetas",
  right_brace: "fechar chavetas",
  left_paren: "abrir parênteses",
  right_paren: "fechar parênteses",
  dot: "ponto",
  colon: "dois pontos",
  newline: "nova linha",
  indent: "indentação",
