              ...
              <div className="flex items-center gap-5">
                <div className="relative">
                  {teacher.avatarUrl ? (
                    ...
                    <div className="w-16 h-16 rounded-2xl bg-primary/20 flex items-center justify-center text-primary text-xl font-bold border-2 border-primary/20">
                      {teacher.name.charAt(0).toUpperCase()}
                    </div>
                  )}
                  <div className="absolute -bottom-2 -right-2 bg-primary text-slate-900 text-[10px] font-black px-2 py-1 rounded-md shadow-lg">
                    PRO
                  </div>
                </div>
                <div>
          ...
          {members.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {members.map((member: any) => (
                <div
                  key={member.id}
                  className="bg-card/80 dark:bg-white/5 border border-border dark:border-white/5 p-4 rounded-xl flex items-center justify-between hover:border-primary/50 transition-colors"
                >
                  ...
                  <div className="text-right">
                    ...
                    <div className="w-20 h-1 bg-muted dark:bg-black/40 rounded-full mt-2 ml-auto overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${member.progress?.percentage || 0}%`,
                        }}
                      ></div>
                    </div>
                  </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="w-full h-2 bg-muted dark:bg-black/40 rounded-full overflow-hidden">
                <div
                  className="h-full bg-linear-to-r from-primary to-[#10b981]"
                  style={{ width: `${classAveragePct}%` }}
                ></div>
              </div>
            </div>
          </div>
