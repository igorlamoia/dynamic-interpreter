  ...
  if (classes.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-24 rounded-3xl border border-border bg-card/70 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:border-white/5 dark:bg-white/2 dark:shadow-[0_8px_32px_rgba(0,0,0,0.2)]">
        <div className="w-24 h-24 mb-6 rounded-full bg-linear-to-br from-[#0dccf2]/10 to-[#10b981]/10 flex items-center justify-center border border-border dark:border-white/10 dark:shadow-[inner_0_0_20px_rgba(13,204,242,0.1)]">
