              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <select
                      {...field}
                      className="w-full h-11 bg-background/80 border border-input rounded-md px-3 text-sm text-foreground focus:outline-none focus:border-[#0dccf2]/50 dark:bg-black/30 dark:border-white/10 dark:text-slate-100"
                    >
