...
As atividades listadas a seguir foram conduzidas de forma conjunta por Victor de Souza Vilela da Silva e Igor Lamoia Queiroz, com participação efetiva de ambos os integrantes em todas as etapas de especificação, implementação e revisão:
...
\begin{itemize}
    ...
    \item Implementação do núcleo do compilador: análise léxica, análise sintática, geração e execução de código intermediário;
    \item Especificação e implementação dos mecanismos de injeção dinâmica de regras gramaticais no interpretador;
...
\subsection{Victor de Souza Vilela da Silva (este documento)}
