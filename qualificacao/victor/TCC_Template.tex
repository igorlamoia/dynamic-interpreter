...
\noindent O ensino de programação apresenta diversos desafios, em parte devido ao uso de linguagens cuja escrita é definida por sintaxe
fixa e palavras-chave reservadas. Isso pode dificultar a assimilação por parte dos estudantes que,
 ...
 Diante desse cenário, o projeto do qual este trabalho faz parte propõe uma plataforma educacional composta por um Ambiente de Desenvolvimento Integrado (IDE) web conectado a um interpretador dinâmico, que permite ao usuário personalizar a sintaxe da linguagem, incluindo as palavras reservadas, os operadores e as regras estruturais. A plataforma é desenvolvida em coautoria e está dividida em dois eixos complementares: o Ambiente de Desenvolvimento Integrado, tratado no documento complementar, e o núcleo de tradução, objeto deste trabalho. O presente documento tem por objetivo projetar, implementar e integrar esse núcleo, contemplando as fases de análise léxica, sintática e semântica, a geração de código intermediário e a execução pelo interpretador, com suporte à injeção dinâmica das regras gramaticais definidas pelo usuário. Os procedimentos adotados compreendem a revisão de literatura, a modelagem da arquitetura, a implementação incremental orientada por testes automatizados e a definição do protocolo de avaliação da solução. Espera-se que a plataforma possa atuar como facilitadora do processo de ensino-aprendizagem, reduzindo as barreiras linguísticas iniciais e incentivando a experimentação; a verificação dessa expectativa junto a estudantes não integra o escopo deste trabalho e é registrada como encaminhamento futuro. O diferencial da proposta está em permitir a redefinição flexível do vocabulário e das regras estruturais da linguagem, adaptando-a ao repertório do estudante.
