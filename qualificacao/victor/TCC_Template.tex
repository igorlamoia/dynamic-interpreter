...
\usepackage{hyperref}
\usepackage{xurl}
% Mantém a área útil exata do modelo, sem arredondamento à linha do memoir.
\setlrmarginsandblock{3cm}{2cm}{*}
\setulmarginsandblock{3cm}{2cm}{*}
\checkandfixthelayout[fixed]
% Reserva 3pt para a extensão visual dos glifos na última linha.
\addtolength{\textheight}{-3pt}
% Pontuação também deve permanecer dentro das margens.
...
\lstset{
    language=toml,
    basicstyle=\ttfamily\small\linespread{1}\selectfont,        % Fonte monoespaçada e menor
    ...
    everydisplay={\vspace*{4pt}},       % Inclui o topo da moldura na área útil
    xleftmargin=22pt,                  % Reserva espaço para números e moldura
    xrightmargin=4pt,
    numbersep=6pt,
    float=htbp,                        % Inicializa o ambiente flutuante
    floatplacement=htbp,
    float=true                         % Preserva o padrão em todas as listagens
}
...
\chapter{RESULTADOS DA AVALIAÇÃO} \label{cap:resultados}
\input{texto/resultados-avaliacao}
