...
O presente Trabalho de Conclusão de Curso foi desenvolvido em regime de cooperação técnico-científica, em coautoria com o acadêmico Igor Lamoia Queiroz, do Curso de Engenharia de Computação do Centro Federal de Educação Tecnológica de Minas Gerais, Unidade Leopoldina. Esta pesquisa constitui-se como parte complementar e interdependente do estudo intitulado \textit{Interpretador Dinâmico para Ensino de Programação: Uma abordagem interativa com Ambiente de Desenvolvimento Integrado (IDE) para personalização e execução de comandos definidos pelo usuário}, de autoria do referido coautor e submetido ao mesmo curso desta Instituição.

Embora ambos os documentos compartilhem a mesma fundamentação macro e o mesmo objeto de estudo, a saber, uma plataforma educacional web composta por um interpretador dinâmico acoplado a uma IDE com gramática configurável pelo usuário, as abordagens possuem escopos específicos e delimitações metodológicas distintas. Enquanto este volume detém-se no núcleo de tradução, examinando em profundidade as fases de análise léxica, análise sintática, geração de código intermediário e execução pelo interpretador, o documento complementar volta-se ao Ambiente de Desenvolvimento Integrado, focando sua arquitetura, a concepção do assistente de personalização da linguagem, a experiência de uso da plataforma e os mecanismos de coleta de retroalimentação. Para uma compreensão holística do sistema proposto, recomenda-se a leitura integrada de ambos os documentos.
