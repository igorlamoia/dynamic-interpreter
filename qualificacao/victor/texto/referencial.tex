...
Para a fundamentação teórica acerca da gestão de escopo e dos princípios de desenvolvimento iterativo e incremental que orientaram este trabalho, esta subseção baseia-se nos princípios discutidos por \citeonline{agile2012} e toma como referência as diretrizes do \textit{framework} Scrum detalhadas por \citeonline{sabbagh2014}, das quais foram incorporadas práticas pontuais, como a organização do trabalho em ciclos curtos, sem a adoção de seus papéis e cerimônias formais. Com o intuito de manter a fluidez da leitura, os conceitos de planejamento, empirismo e gerenciamento de tarefas apresentados a seguir refletem a consolidação das práticas e das ideias desses autores. %

O gerenciamento clássico de projetos de software, frequentemente baseado no modelo em cascata (\textit{waterfall}), assume que o desenvolvimento pode ser tratado como uma sequência previsível e linear de atividades. No entanto, a engenharia de software lida com sistemas intrinsecamente complexos e com alto grau de incerteza, onde o engessamento de requisitos em fases iniciais costuma resultar em enorme desperdício e na entrega de produtos que não atendem às reais necessidades do cliente. Em contraponto a essa visão, as metodologias ágeis assumem a imprevisibilidade natural do desenvolvimento, baseando-se no empirismo e em ciclos de \textit{feedback} constante para promover a adaptação contínua e a entrega contínua de valor \cite{pressman2016,sommerville2018}. %
...
Além disso, a plataforma é construída estritamente em torno de padrões abertos, notadamente a especificação OpenAPI e o JSON Schema. Essa aderência aos padrões permite que o FastAPI gere de forma automática e dinâmica a documentação interativa da API, disponibilizando interfaces prontas para o consumo do desenvolvedor, como o Swagger UI e o ReDoc. Isso reduz drasticamente o tempo gasto com a documentação manual, facilita a integração com sistemas de \textit{front-end} e permite a geração automática de clientes (\textit{SDKs}) em diversas linguagens.
