...
Esta seção analisa ferramentas e linguagens que compartilham objetivos com a solução proposta, seja no apoio ao ensino de programação, seja na construção de compiladores para fins didáticos. Cada trabalho é descrito quanto à sua proposta, às suas características e às suas limitações; ao final, uma análise crítica consolida a comparação e evidencia o diferencial da plataforma desenvolvida frente ao estado da arte.
