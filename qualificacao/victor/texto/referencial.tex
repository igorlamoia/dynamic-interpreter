...
Para a fundamentação das decisões arquiteturais e dos padrões de projeto adotados neste trabalho, esta subseção baseia-se primordialmente nos preceitos de Arquitetura Limpa propostos por \citeonline{martin_clean} e nas diretrizes de design de software estruturadas por \citeonline{silveira2012}.
...
Para o detalhamento conceitual e a definição das práticas de \textit{Clean Code} (Código Limpo) descritas nesta subseção, este trabalho fundamenta-se nas consolidadas diretrizes de \citeonline{martin_clean_code} e na literatura de apoio sobre metodologias ágeis abordada por \citeonline{agile2012}.
...
Para a fundamentação conceitual acerca do uso de tecnologias no ambiente escolar abordada nesta subseção, este trabalho apoia-se nas perspectivas sobre plataformas educativas delineadas por \citeonline{benedetti2025} e nas diretrizes de inovação em tecnologia educacional da \citeonline{mindmakers2025}.
