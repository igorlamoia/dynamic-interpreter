...
O Capítulo~\ref{cap:consideracoes} retoma os objetivos, apresenta os resultados técnicos e as limitações e delimita os trabalhos futuros. A Seção~\ref{sec:protocolo-avaliacao} descreve o instrumento de avaliação, dirigido a um painel de especialistas e ainda não aplicado. O Capítulo~\ref{cap:resultados} está reservado à análise dos dados.
