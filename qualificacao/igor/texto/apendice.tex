...
\begin{itemize}
    ...
    \item Especificação do protocolo de avaliação da experiência de uso, com os instrumentos de coleta, as escalas de usabilidade e o cálculo dos escores. O protocolo é dirigido a um painel de especialistas e ainda não foi aplicado.
\end{itemize}
