...
As atividades listadas a seguir foram conduzidas de forma conjunta por Igor Lamoia Queiroz e Victor de Souza Vilela da Silva, com participação efetiva de ambos os integrantes em todas as etapas de especificação, implementação e revisão:
...
\begin{itemize}
    ...
    \item Estudos de caso centrados na usabilidade, no engajamento dos estudantes e no feedback coletado em ambiente educacional.
\end{itemize}
