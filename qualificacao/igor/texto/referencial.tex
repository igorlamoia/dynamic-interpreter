...
Esta subseção usa como base a obra clássica de \citeonline{aho1995}, amplamente reconhecida na literatura de Ciência da Computação como uma das principais referências teóricas no projeto de compiladores. As definições de análise, síntese e estrutura do processo de compilação apresentadas a seguir seguem as ideias desses autores.
