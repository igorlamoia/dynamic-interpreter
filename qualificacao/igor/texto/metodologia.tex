...
\subsection{Página Inicial e Identidade Visual}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        ...
        \label{fig:etapa2}
    \end{subfigure}
    \caption{Etapas iniciais do assistente de personalização da linguagem.}
    \label{fig:etapas-iniciais}
    \legend{Fonte: elaborado pelo autor.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Etapas/etapa5_1.png}
