...
A pré-visualização permite inspecionar a escrita resultante antes de salvar a configuração. Sua utilidade para iniciantes será examinada pelas tarefas propostas na Seção~\ref{sec:protocolo-avaliacao}.
