...
\begin{figure}[p]
    ...
    \node[uc] (ucVinc) at (20.0, 0.0) {Vincular linguagem\\a exercício ou lista};
    ...
    \begin{scope}[on background layer]
      \foreach \d in {ucCad,ucAut,ucLing,ucAtiv,ucEdit,ucArq,ucExec,ucTok,ucDep}
