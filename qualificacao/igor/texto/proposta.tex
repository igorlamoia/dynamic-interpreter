...
\draw[thick] (3,1) rectangle (11,-13.5);
\node[font=\small\bfseries] at (7,.65) {Plataforma educacional web};
\pic at (0,0) {ator}; \node[font=\small] at (0,-1.65) {Visitante};
\pic at (14,-6) {ator}; \node[font=\small,align=center] at (14,-7.8) {Usuário\\autenticado};
\node[uc] (ucCad) at (7,-0.0) {Cadastrar-se};
\node[uc] (ucAut) at (7,-1.25) {Autenticar-se};
\node[uc] (ucPer) at (7,-2.5) {Gerenciar perfil};
\node[uc] (ucLing) at (7,-3.75) {Criar e gerenciar\\linguagens personalizadas};
\node[uc] (ucCom) at (7,-5.0) {Compartilhar e importar\\linguagens da comunidade};
\node[uc] (ucAtiv) at (7,-6.25) {Ativar linguagem\\no editor};
\node[uc] (ucEdit) at (7,-7.5) {Editar código na IDE};
\node[uc] (ucArq) at (7,-8.75) {Gerenciar arquivos\\do projeto};
\node[uc] (ucExec) at (7,-10.0) {Executar programa\\no terminal};
\node[uc] (ucTok) at (7,-11.25) {Inspecionar \textit{tokens} e\\código intermediário};
\node[uc] (ucDep) at (7,-12.5) {Depurar execução\\passo a passo};
\begin{scope}[on background layer]
\foreach \d in {ucCad,ucAut,ucLing,ucAtiv,ucEdit,ucArq,ucExec,ucTok,ucDep} \draw[liga] (0.35,-.4) -- (\d);
\foreach \d in {ucPer,ucLing,ucCom,ucAtiv,ucEdit,ucArq,ucExec,ucTok,ucDep} \draw[liga] (13.65,-6.4) -- (\d);
\end{scope}
\end{tikzpicture}}
...
\draw[thick] (3,1) rectangle (11,-13.5);
\node[font=\small\bfseries] at (7,.65) {Plataforma educacional web};
\pic at (7,4) {ator}; \node[font=\small,align=center] at (7,2.25) {Usuário autenticado};
\pic at (0,1) {ator}; \node[font=\small] at (0,-.65) {Aluno};
\pic at (14,1) {ator}; \node[font=\small] at (14,-.65) {Professor};
\draw[heranca] (0,1.25) -- (0,3.6) -- (6.55,3.6);
\draw[heranca] (14,1.25) -- (14,3.6) -- (7.45,3.6);
\node[uc] (ucIng) at (7,-0.0) {Ingressar em turma};
\node[uc] (ucCons) at (7,-1.25) {Consultar listas\\e exercícios};
\node[uc] (ucSub) at (7,-2.5) {Submeter solução\\de exercício};
\node[uc] (ucVer) at (7,-3.75) {Consultar veredito\\e histórico};
\node[uc] (ucTur) at (7,-5.0) {Gerenciar turmas};
\node[uc] (ucMem) at (7,-6.25) {Gerenciar membros\\da turma};
\node[uc] (ucEx) at (7,-7.5) {Gerenciar exercícios\\e casos de teste};
\node[uc] (ucVinc) at (7,-8.75) {Vincular linguagem\\a exercício ou lista};
\node[uc] (ucLis) at (7,-10.0) {Gerenciar listas\\de exercícios};
\node[uc] (ucPub) at (7,-11.25) {Publicar lista\\para a turma};
\node[uc] (ucAva) at (7,-12.5) {Acompanhar e avaliar\\submissões};
\begin{scope}[on background layer]
\foreach \d in {ucIng,ucCons,ucSub,ucVer} \draw[liga] (0.35,.6) -- (\d);
\foreach \d in {ucTur,ucMem,ucEx,ucVinc,ucLis,ucPub,ucAva} \draw[liga] (13.65,.6) -- (\d);
\end{scope}
\end{tikzpicture}}
\legend{Fonte: elaborado pelo autor.}
\end{figure}
