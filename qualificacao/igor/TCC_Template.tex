...
\orientadorTitulo{Prof.} %%Colocar a titulação do(a) orientador(a) dentro de chaves {}. Ex: Me., Dr., Dra., etc.
...
\printafolhaderosto{\folhaderostonome}
...
\printafolhaaprov{\folhadeaprovacaonome}
